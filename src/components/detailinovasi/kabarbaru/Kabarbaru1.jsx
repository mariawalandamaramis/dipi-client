...
const Kabarbaru1 = () =>{
  return (
    <span className="items-start border flex flex-col px-8 py-10 rounded-lg border-solid border-emerald-900 max-md:px-5">
      ...
      <div className="self-stretch text-emerald-900 text-lg leading-7 mt-5 max-md:max-w-full">
        Pencarian dukungan untuk inovasi helm batok kelapa yang diluncurkan pada
        tanggal 29 November 2023 terus berlangsung. Hingga tanggal 5 Desember
        2023, penggalangan dana tersebut telah mencapai 50% dari target yang
        ditetapkan, yaitu sebesar Rp5 juta.
        <br />
        <br />
        ...
        kelapa optimis bahwa inovasi ini dapat segera diproduksi secara massal.
      </div>
    </span>
  );
}
