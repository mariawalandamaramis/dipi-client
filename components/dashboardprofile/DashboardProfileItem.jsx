                            ...
                            <div className="flex flex-col justify-center items-stretch max-md:mt-10">
                                ...
                                <div className="flex gap-3 justify-between items-stretch mt-5">
                                    <div className="flex gap-1 justify-between items-stretch px-5 py-3.5 text-sm font-semibold leading-5 text-center text-white whitespace-nowrap bg-emerald-900 rounded-md shadow-sm">
                                        <img
                                            loading="lazy"
                                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/dcfa68b232a4c18d59c56b32ee074a277b133788133eee13585c3f972ce00407?"
                                            className="object-center w-2.5 aspect-square fill-zinc-50"
                                        />
                                        <button className="grow">Unggah foto baru</button>
                                    </div>
                                    <div className="flex flex-col justify-center items-center px-5 py-2.5 bg-emerald-900 rounded-md shadow-sm aspect-[1.37]">
                                        <img
                                            loading="lazy"
                                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/010061abc0d79318b765b0e5ab4490c77fd637dd461a2a3ea6a854641734f1c5?"
                                            className="object-center w-4 aspect-[0.88] fill-white"
                                        />
                                    </div>
                                </div>
                            </div>
